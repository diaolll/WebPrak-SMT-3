...
Route::get('/resepsionis/pemilik', [\App\Http\Controllers\Resepsionis\PemilikController::class, 'index'])
    ...
    Route::put('/resepsionis/update-status/{id}', 
...
Route::middleware('isDokter')->group(function () {
    Route::get('/dokter', [App\Http\Controllers\dokter\DokterController::class, 'index'])->name('admin.Dokter.Dashboard_dokter');
Route::get('/dokter/profil', [DokterController::class, 'profile'])
    ->name('dokter.profile')
    ->middleware('auth');
});
