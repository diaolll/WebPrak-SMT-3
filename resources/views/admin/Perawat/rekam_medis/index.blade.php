    ...
    <div class="col-lg-12">
        <div class="card shadow-sm border-0">
            ...
            <div class="card-header border-bottom d-flex justify-content-between align-items-center">
                ...
                <a href="{{ route('admin.Perawat.rekam_medis.create', $pet->idpet) }}" 
            ...
            <div class="card-body">
                            ...
                            <tr>
                                ...
                                <td class="text-center">
                                    <div class="d-flex justify-content-center">
                                        ...
                                        {{-- EDIT --}}
                                        <a href="{{ route('admin.Perawat.rekam_medis.edit', $r->idrekam_medis) }}" 
                                        ...
                                        {{-- HAPUS --}}
                                        <form method="POST" 
                                              action="{{ route('admin.Perawat.rekam_medis.destroy', $r->idrekam_medis) }}"
                ...
                <div class="mt-4">
                    <a href="{{ route('admin.Perawat.pet.index') }}" 
