...
<h1 class="app-page-title">Tambah Kode Tindakan Terapi</h1>
<nav aria-label="breadcrumb">
    <ol class="breadcrumb">
        <li class="breadcrumb-item">
            <a href="#">Master Data</a>
        </li>
        <li class="breadcrumb-item active" aria-current="page">Tambah Kode Tindakan Terapi</li>
    </ol>
</nav>
@endsection
    ...
    <div class="col-lg-8"> 
        <div class="card shadow-sm border-0"> 
            ...
            <div class="card-header border-bottom">
                <h5 class="mb-0 card-title fw-bold">Form Tambah Kode Tindakan Terapi</h5>
            </div>
            ...
            <div class="card-body">
                ...
                <form action="{{ route('admin.kode_tindakan_terapi.store') }}" method="POST">
                    ...
                    {{-- Input NAMA TINDAKAN (Input ini akan mengisi kolom DESKRIPSI di DB) --}}
                    <div class="mb-3">
