...
<h1 class="app-page-title">Edit Hewan Peliharaan</h1>
    ...
    <div class="col-lg-8">
        <div class="card shadow-sm border-0">
            ...
            <div class="card-header border-bottom">
                <h5 class="mb-0 card-title fw-bold">Edit Hewan Peliharaan: {{ $pet->nama }}</h5>
            </div>
            ...
            <div class="card-body">
                ...
                <form action="{{ route('admin.daftar_pet.update', $pet->idpet) }}" method="POST">
                    @csrf 
                    ...
                    <div class="mb-3">
                        ...
                        <select name="idras_hewan" id="idras_hewan" class="form-select @error('idras_hewan') is-invalid @enderror" required>
                            ...
                            @foreach ($rasHewan as $rh)
                                <option value="{{ $rh->idras_hewan }}" {{ old('idras_hewan', $pet->idras_hewan) == $rh->idras_hewan ? 'selected' : '' }}>
                                    {{ $rh->nama_ras }}
                                </option>
                            @endforeach
                        </select>
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" name="warna_tanda" id="warna_tanda" class="form-control @error('warna_tanda') is-invalid @enderror" value="{{ old('warna_tanda', $pet->warna_tanda) }}" placeholder="Contoh: Belang putih di dada">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="date" name="tanggal_lahir" id="tanggal_lahir" class="form-control @error('tanggal_lahir') is-invalid @enderror" value="{{ old('tanggal_lahir', $pet->tanggal_lahir ? \Carbon\Carbon::parse($pet->tanggal_lahir)->format('Y-m-d') : '') }}">
