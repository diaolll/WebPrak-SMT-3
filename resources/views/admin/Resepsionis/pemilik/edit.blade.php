...
<h1 class="app-page-title">Edit Data Pemilik</h1>
    ...
    <div class="col-lg-8">
        <div class="card shadow-sm border-0">
            ...
            <div class="card-header border-bottom">
                <h5 class="mb-0 card-title fw-bold">Form Edit Pemilik & Akun User</h5>
            </div>
            ...
            <div class="card-body">
                ...
                <form action="{{ route('admin.resepsionis.pemilik.update', $pemilik->idpemilik) }}" method="POST">
                    @csrf 
                    @method('PUT')
                    ...
                    <div class="mb-3">
                        ...
                        <input 
                            ...
                            value="{{ old('nama', $pemilik->user->nama ?? $pemilik->user->name ?? '') }}" 
                    ...
                    <div class="d-flex justify-content-between mt-4">
                        <a href="{{ route('admin.resepsionis.pemilik.index') }}" 
