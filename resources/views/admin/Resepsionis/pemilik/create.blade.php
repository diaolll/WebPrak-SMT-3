    ...
    <div class="col-lg-8">
        <div class="card shadow-sm border-0">
            ...
            <div class="card-body">
                ...
                <form action="{{ route('admin.resepsionis.pemilik.store') }}" method="POST">
                    @csrf 
                    ...
                    <div class="d-flex justify-content-between mt-4">
                        <a href="{{ route('admin.resepsionis.pemilik.index') }}" class="btn btn-outline-secondary waves-effect">
